...
$id=$_GET['id'];
$edit=$con->query("select * from expense_category where id=$id")->fetch_assoc();

//require_once('../database_con.php');
if(isset($_POST['submit'])){
    $name=$_POST['name'];
    
    $dip=$con->query("UPDATE `expense_category` SET `name`='$name' WHERE id=$id");
    ?>
    <script>
            ...
            <div>
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Expense Category List Edit</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
